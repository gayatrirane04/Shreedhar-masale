      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3 bg-white px-3 py-2 rounded-lg shadow-md">
            <img src="/logo.png" alt="Shreedhar Masale Logo" className="h-8 w-auto object-contain mix-blend-multiply" />
          ...
          <div className="flex items-center gap-4">
            ...
            <ul className="hidden md:flex gap-6 text-sm">
              ...
              <li><a href="/#latest" className="hover:bg-white/20 px-3 py-2 rounded transition">Upcomings</a></li>
            </ul>
        ...
        {isMenuOpen && (
          <ul className="md:hidden flex flex-col gap-2 mt-4 pb-2">
            ...
            <li><a href="/#latest" onClick={() => setIsMenuOpen(false)} className="block hover:bg-white/20 px-3 py-2 rounded transition">Upcomings</a></li>
          </ul>
        )}
      </div>
    </nav>
